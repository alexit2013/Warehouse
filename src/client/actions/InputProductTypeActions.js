...
import { productTypeSearchByNameServer } from 'services';

export const resultHidden = ( ) => ({type : constants.INPUT_PRODUCT_TYPE_HIDDEN_RESULT});

export const resultShow = ( ) => ({type : constants.INPUT_PRODUCT_TYPE_SHOW_RESULT});

export const setResult = ( result = [] ) => ({
    type: constants.INPUT_PRODUCT_TYPE_SET_RESULT,
    result
});


export const searchByName = name => dispatch =>
    productTypeSearchByNameServer( name )
        .then((response) => {
...
export const setValue = ( inputValue = '' )   =>
    ({
        type : constants.INPUT_PRODUCT_TYPE_SET_VALUE,
        inputValue
    });

    ...
    handlerOnClick(event) {
        ...
        if (element) {
            if (element.classList.contains('result-item')) {
                ...
                this.props.handlerChangeValue( { name, id });
...
const mapStateToProps = state => ({
    inputProps : state.InputProductTypeReducer
});
...
export default connect(mapStateToProps, mapDispatchToProps)(InputProductType);
